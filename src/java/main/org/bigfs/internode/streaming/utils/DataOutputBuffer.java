 ...
 */
package org.bigfs.internode.streaming.utils;

import java.io.DataOutputStream;
import java.io.IOException;

import org.bigfs.utils.FastByteArrayOutputStream;
...
public final class DataOutputBuffer extends DataOutputStream
{
    ...
    public byte[] getData()
    {
        return ((FastByteArrayOutputStream) out).getBuffer();
    }

    /** Returns the length of the valid data currently in the buffer. */
    public int getLength()
    {
        return ((FastByteArrayOutputStream) out).size();
    }
}
